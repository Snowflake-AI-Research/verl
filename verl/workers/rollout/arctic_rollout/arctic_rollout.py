...
class ArcticLLMEngine:
    ...
    async def generate(
        ...
        gen_batch_output = await self.arctic_rl_client.generate.remote(
            prompt_ids=prompt['prompt_token_ids'],
            sampling_params=sampling_params,
        )
        # print(f"arctic_async_server: {gen_batch_output=}, {type(gen_batch_output)=}")
        # gen_batch_output = await ray.get(gen_batch_output)
